...
namespace DataProvider.Migrations
{
    ...
    [Migration("20210524163003_add_StatusToSoftware")]
    partial class add_StatusToSoftware
    {
            ...
            modelBuilder.Entity("Entity.Identity.Person", b =>
                {
                    ...
                    b.Property<short?>("CountryLivingCountryId")
                        .HasColumnType("smallint");
                    ...
                    b.Property<short?>("NationalityCountryId")
                        .HasColumnType("smallint");
                    ...
                    b.HasIndex("CountryLivingCountryId");
            ...
            modelBuilder.Entity("Entity.Identity.Person", b =>
                {
                    b.HasOne("Entity.BaseInfo.Country", "CountryLiving")
                        .WithMany()
                        .HasForeignKey("CountryLivingCountryId");

                    b.HasOne("Entity.BaseInfo.Country", null)
