        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KeyExpire = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryLivingCountryId = table.Column<short>(type: "smallint", nullable: true),
                    NationalityId = table.Column<short>(type: "smallint", nullable: true),
                    NationalityCountryId = table.Column<short>(type: "smallint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.CountryLivingCountryId,
                        principalSchema: "BaseInfo",
                        principalTable: "Countries",
                        principalColumn: "CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailConfirmationExpiry = table.Column<long>(type: "bigint", nullable: false),
                    EmailConfirmationSecret = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PasswordHash = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PasswordSalt = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastLoginDate = table.Column<long>(type: "bigint", nullable: true),
